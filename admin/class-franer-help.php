...
class Franer_Help {
	...
	public static function get_default_activity_prompt() {
		...
		$lines = array(
			...
			__( 'Make it a quality resource: responsive, accessible (labels, contrast, visible focus), CSS variables for the palette, @media print rules, and show field validation in-page (never with alert).', 'franer' ),
			'',
			...
			'  /* validate required fields (show errors in-page), then: */',
